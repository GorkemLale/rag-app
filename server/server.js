...
const URI_DATABASE_HOST = process.env.MONGODB_URI_HOST;
const URI_DATABASE_CONTAINER = process.env.MONGODB_URI_CONTAINER;

// MongoDB bağlantısı
mongoose.connect(URI_DATABASE_CONTAINER || 'mongodb://mongodb:27017/rag-app')
